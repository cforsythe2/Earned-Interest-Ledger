...
public class GUI extends JFrame {
            ...
            public void actionPerformed(ActionEvent b) {
                try {
                    if (checkingButton.isSelected()) {
                        ...
                        String formatEarnings = dc.format(cEI);
                        ...
                        String formatEarnings = dc.format(sEI);
                        textField.setText(formatEarnings);
            ...
            public void actionPerformed(ActionEvent a) {
                try {
                    ...
                    if (checkingButton.isSelected()) {
                        ...
                        setPane(popupWidth, popupHeight, "Success", "Update successful.");
            ...
            public void actionPerformed(ActionEvent a) {
                try {
                    ...
                    if (checkingButton.isSelected()) {
                        ...
                        //    String s = String.valueOf(amountBal);
                        setPane(popupWidth, popupHeight, "Success", "Update successful.");
                        ...
                        String formatRate = dc.format(nRate);
                        Log.saveData("AutoSavinhsRate.txt", formatRate);
                        //    String s = String.valueOf(amountBal);
                        setPane(popupWidth, popupHeight, "Success", "Update successful.");
            ...
            public void actionPerformed(ActionEvent b) {
                try {
                    if (checkingButton.isSelected()) {                       
                        ...
                        //    String sb = String.valueOf(totBal);
                        textBalance.setText(formatBal);
                        textField.setText(formatEarnings);
                        //    checking.interestCalc(Double.valueOf(Log.interestR));
                        setPane(popupWidth, popupHeight, "Balance", "Interest Earned: $" + formatter.format(earnings));
                        Log.saveData("checkingRate.txt", rate);
                        Log.saveData("checkingAccount.txt", dnum);
                    } else if (savingsButton.isSelected()) {
                        textDate.setText(" ");
                        f.openInterestS();
                        f.ReadInterestS();
                        ...
                        //    checking.interestCalc(Double.valueOf(Log.interestR));
                        setPane(popupWidth, popupHeight, "Balance", "Interest Earned: $" + formatter.format(earnings));
                        Log.saveData("savingsRate.txt", rate);
                        Log.saveData("savingsAccount.txt", dnum);
                ...
                try {
                    ...
                    if (textField.getText().matches("[0-9]+") == false) {
                        ...
                        if (checkingButton.isSelected()) {
                            ...
                            setPane(popupWidth, popupHeight, "Success", "Deposit successful.");
                            ...
                            String formatBal = dc.format(nBal);
                            Log.saveData("AutoSavings.txt", formatBal);
                            setPane(popupWidth, popupHeight, "Success", "Deposit successful.");
                        ...
                        if (amount % 20 == 0) {
                            ...
                            if (checkingButton.isSelected()) {
                                try {
                                    ...
                                    setPane(popupWidth, popupHeight, "Success", "Withdrawal successful.");
        ...
        reset.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent a) {
                try {
                    ...
                    //    String sb = String.valueOf(totBal);
                        textBalance.setText(formatBal);
                        textField.setText(formatRate);
                        //    checking.interestCalc(Double.valueOf(Log.interestR));
                     //   setPane(popupWidth, popupHeight, "Balance", "Interest Earned: $" + formatter.format(earnings));
                        Log.saveData("checkingRate.txt", formatRate);
                        Log.saveData("checkingAccount.txt", formatBal);
                    } else if (savingsButton.isSelected()) {
                        f.openInterestS();
                        f.ReadInterestS();
                        textField2.setText(Log.savingsRate);
    ...
    public static void main(String[] args) {
        ...
        if (file1.exists() && file2.exists() && file3.exists() && file4.exists() && file5.exists() && file6.exists()) {
            ...
            f.checkFile("checkingAccount.txt", "3000.00");
            f.checkFile("checkingRate.txt", "3.00");
            f.checkFile("checkingDate.txt", "2021-05-01");
            f.checkFile("savingsAccount.txt", "200000.00");
            f.checkFile("savingsRate.txt", "12.00");
            f.checkFile("savingsDate.txt", "2021-05-01");
            
            
            f.checkFile("AutoDateC.txt", "2021-04-29");
            f.checkFile("AutoChecking.txt", "3000.00");
            f.checkFile("AutoCheckingRate.txt", "3.00");
            f.checkFile("AutoEarnChecking.txt", " 0.25");
            
            f.checkFile("AutoDateS.txt", "2021-04-29");
            f.checkFile("AutoSavings.txt", "200000.00");
            f.checkFile("AutoSavingsRate.txt", "12.00");
            f.checkFile("AutoEarnSavings.txt", " 0.25");
